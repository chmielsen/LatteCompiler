...
public class SDecl extends Stmt {
  public final Type type_;
  public final ListItem listitem_;

  public SDecl(Type p1, ListItem p2) { type_ = p1; listitem_ = p2; }

  public <R,A> R accept(Latte.Absyn.Stmt.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof Latte.Absyn.SDecl) {
      Latte.Absyn.SDecl x = (Latte.Absyn.SDecl)o;
