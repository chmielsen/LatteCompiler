...
public class SWhile extends Stmt {
  public final Expr expr_;
  public final Stmt stmt_;

  public SWhile(Expr p1, Stmt p2) { expr_ = p1; stmt_ = p2; }

  public <R,A> R accept(Latte.Absyn.Stmt.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof Latte.Absyn.SWhile) {
      Latte.Absyn.SWhile x = (Latte.Absyn.SWhile)o;
