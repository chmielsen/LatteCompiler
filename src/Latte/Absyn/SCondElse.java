...
public class SCondElse extends Stmt {
  public final Expr expr_;
  public final Stmt stmt_1, stmt_2;

  public SCondElse(Expr p1, Stmt p2, Stmt p3) { expr_ = p1; stmt_1 = p2; stmt_2 = p3; }

  public <R,A> R accept(Latte.Absyn.Stmt.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof Latte.Absyn.SCondElse) {
      Latte.Absyn.SCondElse x = (Latte.Absyn.SCondElse)o;
