 ...
 */
public class ProgramTR implements Program.Visitor<Map<String, FunctionSignature>, Object> {
    ...
    public Map<String, FunctionSignature> visit(Program p, Object arg) {
        ...
        for (TopDef topDef : p.listtopdef_) {
            Map.Entry<String, FunctionSignature> idToSignature = topDef.accept(new TopDefTR(), null);
